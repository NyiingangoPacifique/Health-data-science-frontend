 ...
 <div class="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl">
      ...
      <div class="p-8">
           <div class="uppercase tracking-wide text-sm text-indigo-500 font-semibold">UWASE Melissa</div>
            ...
            <p class="mt-2 text-slate-500">
            Melissa Uwase is a dedicated faculty member at the University of Rwanda(UR)and a talented epidemiologist. 
...
<div className="w-10/12 grid grid-cols-2 gap-8 m-auto mt-10" >
       <div class="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl">
            <div class="md:flex">
               <div class="md:shrink-0">
               <img
