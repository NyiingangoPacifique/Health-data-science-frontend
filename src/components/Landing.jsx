...
const Landing = () => {
  ...
  return (
    <div>
      ...
      style={{
          ...
          }}>
        {
          ...
          <div className="flex">
            ...
            <div className="w-10/12 py-5 mb-5 text-left float-right">
              <div>
                <h1 className="font-Sans-serif text-3xl w-10/12 font-light leading-12 tracking-tight m-auto break-words font-semibold sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl ">
          ...
          <div className="flex-col mr-14 font-Sans-serif ">
          <button className="block px-4 py-2 border-b border-gray-200 cursor-pointer hover:bg-gray-100 hover:text-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:border-gray-600 dark:hover:bg-gray-600 dark:hover:text-white dark:focus:ring-gray-500 dark:focus:text-white mt-10 font-bold sm:text-xl md:text-xl lg:text-xl xl:text-xl">
          <Link to="/about">
          About Us 
          </Link>  
          </button>
      ...
      <div className="flex bg-blue-100 py-5 m-auto">
        <div className="w-1/12"></div>
        <div className="py-12 mb-5 text-left float-right w-3/12"> 
          <h className="w-9/12 font-Sans-serif text-2xl font-semibold leading-12 tracking-tight  break-words sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl">
            Exploring the Data
          </h>
        </div>
        <div className="flex-col w-7/12 py-12 mb-5 text-left float-right space-y-10 m-auto ">
          <div className="font-Sans-serif w-10/12 font-light leading-12 tracking-tight  sm:text-xl md:text-xl lg:text-2xl xl:text-2xl ">
      ...
      <div className="flex-col py-10 bg-blue-100">
       ...
       <div className="w-full mt-20 ">
        ...
        <div className="mt-24 mb-14 font-Sans-serif text-2xl font-medium leading-12 tracking-tight sm:text-2xl md:text-3xl lg:text-4xl xl:text-4xl " >
          OUR SERVICES
        </div>
        ...
        <div>
          ...
          <div className="p-5 m-auto" >
                 <p className="font-semibold font-Sans-serif  text-2xl py-5 text-center sm:text-2xl md:text-3xl lg:text-4xl xl:text-4xl">
                  OUR TEAM
                 </p>
                 <p className="font-Sans-serif text-2xl font-light leading-12 tracking-tight text-center sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl"> 
